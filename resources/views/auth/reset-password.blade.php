<x-layout>
    <form method="POST" action="{{ route('password.store') }}">
        ...
        <div>
            ...
            <x-default.text-input id="email" class="block mt-1 w-full" type="email" name="email" :value="old('email', $request->email)" required autofocus autocomplete="username" />
        ...
        <div class="mt-4">
            ...
            <x-default.text-input id="password" class="block mt-1 w-full" type="password" name="password" required autocomplete="new-password" />
        ...
        <div class="mt-4">
            ...
            <x-default.text-input id="password_confirmation" class="block mt-1 w-full"
                                type="password"
